<?php
use App\Core\Router; use App\Controllers\{AuthController,DashboardController,LeadController,UserController,ApiAssessmentController,ReportController,SettingsController}; use App\Middlewares\{AuthMiddleware,GuestMiddleware,AdminMiddleware};
$r=new Router;
...
$r->get('/reports',[ReportController::class,'index'],[AuthMiddleware::class]); $r->get('/settings',[SettingsController::class,'index'],[AuthMiddleware::class]);
